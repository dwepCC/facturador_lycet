...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getFiscalRequeueOrphanedCommandService()
    {
        ...
        $this->privates['App\\Command\\FiscalRequeueOrphanedCommand'] = $instance = new \App\Command\FiscalRequeueOrphanedCommand(($this->privates['App\\Repository\\FiscalDocumentRepository'] ?? $this->getFiscalDocumentRepositoryService()), ($this->privates['App\\Service\\Fiscal\\FiscalOrphanRepairService'] ?? $this->getFiscalOrphanRepairServiceService()), ($this->privates['App\\Service\\Fiscal\\FiscalQueueService'] ?? $this->getFiscalQueueServiceService()));
    ...
    /**
     * Gets the private 'App\Service\Fiscal\FiscalOrphanRepairService' shared autowired service.
     *
     * @return \App\Service\Fiscal\FiscalOrphanRepairService
     */
    protected function getFiscalOrphanRepairServiceService()
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Service'.\DIRECTORY_SEPARATOR.'Fiscal'.\DIRECTORY_SEPARATOR.'FiscalOrphanRepairService.php';

        return $this->privates['App\\Service\\Fiscal\\FiscalOrphanRepairService'] = new \App\Service\Fiscal\FiscalOrphanRepairService(($this->privates['App\\Repository\\FiscalDocumentRepository'] ?? $this->getFiscalDocumentRepositoryService()), ($this->privates['App\\Service\\Fiscal\\FiscalDocumentService'] ?? $this->getFiscalDocumentServiceService()), ($this->privates['App\\Service\\Fiscal\\FiscalQueueService'] ?? $this->getFiscalQueueServiceService()));
    }
