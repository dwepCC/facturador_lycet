...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getFiscalPdfServiceService()
    {
        ...
        return $this->privates['App\\Service\\Fiscal\\FiscalPdfService'] = new \App\Service\Fiscal\FiscalPdfService(($this->services['App\\Service\\PdfReportDecorator'] ?? $this->getPdfReportDecoratorService()), ($this->services['App\\Service\\SeeFactory'] ?? $this->getSeeFactoryService()), new \App\Service\Fiscal\FiscalLogoResolver(($this->privates['App\\Repository\\EmpresaRepository'] ?? $this->getEmpresaRepositoryService()), ($this->services['App\\Service\\FileDataReader'] ?? ($this->services['App\\Service\\FileDataReader'] = new \App\Service\FileDataReader((\dirname(__DIR__, 4).'/data')))), (\dirname(__DIR__, 4).'/data')), ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()));
    }
